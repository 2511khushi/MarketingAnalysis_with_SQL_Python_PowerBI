...
SELECT 
    ...
    CASE -- Categorizes the products into price categories: Low, Medium, or High
        WHEN Price < 100 THEN 'Low'  -- If the price is less than 50, categorize as 'Low'
        WHEN Price BETWEEN 100 AND 300 THEN 'Medium'  -- If the price is between 50 and 200 (inclusive), categorize as 'Medium'
